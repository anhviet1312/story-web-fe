...
interface Story {
  ...
  created_by: string | null // Updated to allow null values
  updated_at: string
  created_at: string
}
        ...
        <Card className="overflow-hidden shadow-lg">
          <CardHeader className="bg-gradient-to-r from-slate-900 to-slate-700 text-white">
            <div className="flex flex-col space-y-4">
              ...
              <CardTitle className="text-2xl md:text-3xl font-bold leading-tight">{story.name}</CardTitle>
              ...
              <div className="flex flex-wrap items-center gap-4 text-sm text-slate-200">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span>ID: {story.created_by ? story.created_by.slice(0, 8) + "..." : "Không xác định"}</span>
                </div>
          ...
          <CardContent className="p-0">
            ...
            <div className="p-6 md:p-8">
              ...
              <div className="prose prose-slate max-w-none">
                <div className="text-slate-700 leading-relaxed whitespace-pre-line text-base">{story.description}</div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
                <div className="space-y-2">
                  ...
                  <div className="space-y-1 text-slate-600">
                    ...
                    <p>
                      <span className="font-medium">Slug:</span> {story.slug}
                    </p>
                    <p>
                      <span className="font-medium">Thể loại:</span> {story.type}
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-1 text-slate-600">
                    <p>
                      <span className="font-medium">Tạo lúc:</span> {formatDate(story.created_at)}
                    </p>
                    <p>
                      <span className="font-medium">Cập nhật:</span> {formatDate(story.updated_at)}
                    </p>
                    <p>
